...
const AddTrackingModal = ({ isOpen, closeModal, trackingId, handleUpdate }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
        <form onSubmit={handleUpdate}>
          ...
          <select name="status" className="border p-2 w-full my-2 rounded">
          ...
          <textarea name="note" placeholder="Note (optional)" className="border p-2 w-full my-2 rounded" />
